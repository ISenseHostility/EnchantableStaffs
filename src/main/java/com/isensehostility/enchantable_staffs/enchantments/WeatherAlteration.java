...
public class WeatherAlteration extends net.minecraft.enchantment.Enchantment {

    public WeatherAlteration(Enchantment.Rarity rarityIn, EquipmentSlotType... slots) {
